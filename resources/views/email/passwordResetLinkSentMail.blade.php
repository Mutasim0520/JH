            ...
            <div class="panel-default" style="background-color: ghostwhite;">
                ...
                <div class="panel-body" style="padding: 10px;">
                    ...
                    <div style="text-align: center">
                        <a href="http://importacebd.com/password/reset/show/form/{{encrypt($user[0]->id)}}" style="text-decoration: none;color: white; font-size: 20px; text-align: center;padding: 10px;background-color: #00A6C7; ">
                            Reset Password</a>
                    </div>
                </div>
            </div>
