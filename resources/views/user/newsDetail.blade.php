                            ...
                            <div class="slider-area">
                                <div class="slider-wrapper owl-carousel">
                                    @if(sizeof($news->broadcasts_image)>0)
                                        @foreach($news->broadcasts_image as $item)
                                                    <img class="img-responsive" style="width: auto; display: block; margin-left: auto; margin-right: auto; max-height:500px;" src="/uploads/news/{{$item->path}}">
                                        @endforeach
                                        @else
                                    @endif
                                </div>
                            ...
                            <div class="blog-text">
                                <div class="content-wrapper">
                                    <div class="post-content-inner">
                                        <h6><?php
                                            echo (date("M jS, Y", strtotime($news->created_at)));
                                            ?></h6>
                                        <?php echo $news->body; ?>
                                    </div>
                                </div>
